...
$scope.getDataUsingPost = function () {
    ...
    .success(function (data, status, headers, config, statusText) {
        ...
        for (j = 1; j<= $scope.size; j++) {
            i = j - 1;
            console.log("display each edit post ", i);
            mycol0 += "<div class='container'>" 
        + "<br>"
        + "<button ng-click=editpostbut();>" + "Edit post" + "</button>"
        + "<button ng-click='deletepostbut();'>" + "Delete post" + "</button>"
            + "<br>" 
