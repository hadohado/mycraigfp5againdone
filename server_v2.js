...
var craigsource = require('craigsource');
// var npmpkgmy = require('npmpkgmy');
...
app.post('/register', function (req, res) {
	...
	//-------------------------------
	// connect to database and write to myql
	//-------------------------------
	var con = craigsource.connectdb();	
...
app.post('/newpost2', function (req, res) {
	...
	console.log("run my own npm package  craigsource");
	somemessage = craigsource.hithere();
	console.log("somemessage ", somemessage);
	
	var craigina = 2;
	var craiginb = 20;
	console.log("craigsourceadd = ", craigsource.craigsourceadd(2, 20));
